...
class RejectCompletedOrderBuyScreen extends StatefulWidget {
  const RejectCompletedOrderBuyScreen({super.key});

  @override
  State<RejectCompletedOrderBuyScreen> createState() =>
      _RejectCompletedOrderBuyScreenState();
}

class _RejectCompletedOrderBuyScreenState
    extends State<RejectCompletedOrderBuyScreen> {
        ...
        child: AuthProvider.userModel!.status == "NOT_VERIFIED"
            ...
            : FutureBuilder(
                future: ApiBuyOderHistory
                    .getAllRejectingCompletedOrderBuyByCustomerID(
