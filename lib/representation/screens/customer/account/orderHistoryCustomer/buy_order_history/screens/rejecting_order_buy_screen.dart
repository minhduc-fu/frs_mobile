...
class RejectingOrderBuyScreen extends StatefulWidget {
  const RejectingOrderBuyScreen({super.key});

  @override
  State<RejectingOrderBuyScreen> createState() =>
      _RejectingOrderBuyScreenState();
}

class _RejectingOrderBuyScreenState extends State<RejectingOrderBuyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: FutureBuilder(
          future:
              ApiBuyOderHistory.getAllRejectingOrderBuyByCustomerID(customerID),
