...
class PrepareOrderBuyScreen extends StatefulWidget {
  const PrepareOrderBuyScreen({super.key});

  @override
  State<PrepareOrderBuyScreen> createState() => _PrepareOrderBuyScreenState();
}

class _PrepareOrderBuyScreenState extends State<PrepareOrderBuyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: FutureBuilder(
          future:
              ApiBuyOderHistory.getAllPrepareOrderBuyByCustomerID(customerID),
