...
class RejectOrderRentScreen extends StatefulWidget {
  const RejectOrderRentScreen({super.key});

  @override
  State<RejectOrderRentScreen> createState() => _RejectOrderRentScreenState();
}

class _RejectOrderRentScreenState extends State<RejectOrderRentScreen> {
    ...
    return Scaffold(
      body: Padding(
        ...
        child: AuthProvider.userModel!.status == "NOT_VERIFIED"
            ...
            : FutureBuilder(
                future: ApiOderRentHistory.getAllRejectingOrderRentByCustomerID(
