...
class PrepareOrderRentScreen extends StatefulWidget {
  const PrepareOrderRentScreen({super.key});

  @override
  State<PrepareOrderRentScreen> createState() => _PrepareOrderRentScreenState();
}

class _PrepareOrderRentScreenState extends State<PrepareOrderRentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Padding(
        ...
        child: FutureBuilder(
          future:
              ApiOderRentHistory.getAllPrepareOrderRentByCustomerID(customerID),
