...
class DeliveryOrderRentScreen extends StatefulWidget {
  const DeliveryOrderRentScreen({super.key});

  @override
  State<DeliveryOrderRentScreen> createState() =>
      _DeliveryOrderRentScreenState();
}

class _DeliveryOrderRentScreenState extends State<DeliveryOrderRentScreen> {
    ...
    return Scaffold(
      body: Padding(
        ...
        child: AuthProvider.userModel!.status == "NOT_VERIFIED"
            ...
            : FutureBuilder(
                future: ApiOderRentHistory.getAllDeliveryOrderRentByCustomerID(
