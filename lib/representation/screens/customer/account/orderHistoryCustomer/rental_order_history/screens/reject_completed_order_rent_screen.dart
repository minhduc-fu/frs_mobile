...
class RejectCompletedOrderRentScreen extends StatefulWidget {
  const RejectCompletedOrderRentScreen({super.key});

  @override
  State<RejectCompletedOrderRentScreen> createState() =>
      _RejectCompletedOrderRentScreenState();
}

class _RejectCompletedOrderRentScreenState
    extends State<RejectCompletedOrderRentScreen> {
        ...
        child: AuthProvider.userModel!.status == "NOT_VERIFIED"
            ...
            : FutureBuilder(
                future: ApiOderRentHistory
                    .getAllRejectingCompletedOrderRentByCustomerID(
